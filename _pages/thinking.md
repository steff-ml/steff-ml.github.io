...
General essays, not tied to a specific project: how I approach the work, what I believe about it, and why. If you want to see the work itself, that's [Products]({{ "/projects/" | relative_url }}) and [Engineering]({{ "/blog/" | relative_url }}) instead.

{% assign thinking_posts = site.posts | where_exp: "post", "post.categories contains 'thinking'" | sort: "date" | reverse %}
